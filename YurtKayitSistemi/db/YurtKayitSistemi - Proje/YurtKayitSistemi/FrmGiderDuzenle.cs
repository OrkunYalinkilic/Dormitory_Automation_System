    ...
    public partial class FrmGiderDuzenle : Form
    {
        ...
        private void btnGuncelle_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                SqlCommand komut = new SqlCommand("update Giderler set Elektrik=@p2, su=@p3, Dogalgaz=@p4, " +
                                        "Internet=@p5, Gida=@p6, Personel=@p7, Diger=@p8 where OdemeID=@p1", bgl.baglanti());
