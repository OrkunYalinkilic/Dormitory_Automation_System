    ...
    public partial class frmPersonelAyrintiIslem : Form
    {
        ...
        private void bilgileriGetir(string idNo)
        {
            ...
            while (oku.Read())
            {
                ...
                MskPersonelTc.Text = p1.tcKimlikNo;
            }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (islem == "ekleme")
            {
                Personel yeni = YeniPersonel(txtAd.Text, txtSoyad.Text, mskTelefon.Text, txtMaas.Text, MskPersonelTc.Text,
                    txtDepartmant.Text);
                ...
                if (yeni.boslukKontrol() == true)
                {
                    ...
                    {
                        SqlCommand cmd = new SqlCommand("insert into Personel (PersonelAd,PersonelSoyad,PersonelDepartman,PersonelMaas,PersonelTelefonNo,PersonelTCKimlikNo) values (@a1,@a2,@a3,@a4,@a5,@a6)", bgl.baglanti());
            ...
            else if (islem == "guncelleme")
            {
                ...
                if (yeni.boslukKontrol() == true)
                {
                    ...
                    else if (YardimciSinif.sayiKontrol(yeni.maas.ToString()) == false)
                    {
                        MessageBox.Show("**Sayı girilmesi gereken bilgiler harf içermemeli.**", "HATA", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
                    else
                    {
                        ...
                        cmd2.Parameters.AddWithValue("@b6", MskPersonelTc.Text);
