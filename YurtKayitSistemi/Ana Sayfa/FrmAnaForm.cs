...
namespace YurtKayitSistemi
{
    ...
    {
        string zaman, girisTip, OgrKullaniciAd, YonKullaniciAd, YonSifre;
        public FrmAnaForm(string _girisTip, string _OgrKullaniciAd, string _YonKullaniciAd, string _YonKullaniciSifre)
        {
            girisTip = _girisTip; OgrKullaniciAd = _OgrKullaniciAd;
            YonKullaniciAd = _YonKullaniciAd; YonSifre = _YonKullaniciSifre;
            InitializeComponent();
        }
        ...
        private void FrmAnaForm_Load(object sender, EventArgs e)
        {
            ...
            if (girisTip == "ogrenci")
            {
                ...
                bölümlerToolStripMenuItem.Visible = false;
                #endregion
            }
        ...
        private void şifreİşlemleriToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            y.kullaniciAdi = YonKullaniciAd;
            y.sifre = YonSifre;

            frmSifreIslem frm = new frmSifreIslem(y);
            frm.ShowDialog();
        }
        ...
        private void yöneticiDüzenleToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            y.kullaniciAdi = YonKullaniciAd;
            y.sifre = YonSifre;
            frmYoneticiDuzenleme frm = new frmYoneticiDuzenleme(y);
            frm.ShowDialog();
        }
